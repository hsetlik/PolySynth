...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    GPIO_InitStruct.Pin = BATT_REF_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(BATT_REF_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA0-WKUP     ------> ADC1_IN0
    */
    HAL_GPIO_DeInit(BATT_REF_GPIO_Port, BATT_REF_Pin);
...
void HAL_SPI_MspInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    GPIO_InitStruct.Pin = PITCH_CS_Pin|PITCH_SCK_Pin|PITCH_MOSI_Pin;
  ...
  /* USER CODE END SPI2_MspInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    GPIO_InitStruct.Pin = EXP_SCK_Pin|EXP_MISO_Pin|EXP_MOSI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI1_MspDeInit 0 */
    ...
    PA7     ------> SPI1_MOSI
    */
    HAL_GPIO_DeInit(GPIOA, PITCH_CS_Pin|PITCH_SCK_Pin|PITCH_MOSI_Pin);
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB15     ------> SPI2_MOSI
    */
    HAL_GPIO_DeInit(GPIOB, EXP_SCK_Pin|EXP_MISO_Pin|EXP_MOSI_Pin);
  ...
  /* USER CODE END SPI3_MspDeInit 0 */
    ...
    PC12     ------> SPI3_MOSI
    */
    HAL_GPIO_DeInit(DISP_CS_GPIO_Port, DISP_CS_Pin);

    HAL_GPIO_DeInit(GPIOC, DISP_SCK_Pin|DISP_MISO_Pin|DISP_MOSI_Pin);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM2_MspPostInit 0 */
    ...
    PA1     ------> TIM2_CH2
    */
    GPIO_InitStruct.Pin = PIXELS_MAIN_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF1_TIM2;
    HAL_GPIO_Init(PIXELS_MAIN_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END TIM5_MspPostInit 0 */
    ...
    PA2     ------> TIM5_CH3
    */
    GPIO_InitStruct.Pin = PIXELS_MATRIX_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM5;
    HAL_GPIO_Init(PIXELS_MATRIX_GPIO_Port, &GPIO_InitStruct);
