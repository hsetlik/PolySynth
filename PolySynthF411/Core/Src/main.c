...
static void MX_GPIO_Init(void) {
	...
	HAL_GPIO_WritePin(GPIOC, HP_MODE_Pin | FOLD_FIRST_Pin | GPIO_PIN_3,
			GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOA, PITCH_RST_Pin | LDAC_Pin | DISP_CS_Pin,
			GPIO_PIN_RESET);

	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB,
			DAC_INH_Pin | DAC_A0_Pin | DAC_A1_Pin | DAC_A2_Pin | DISP_DC_Pin
